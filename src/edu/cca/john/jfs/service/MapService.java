...
import edu.cca.john.jfs.repositories.MapRepository;

public class MapService implements ServiceCRUD{
	...
	@Override
	public void readAll() {
		Map<Long,Mobile> mobiles = repo.readAll();
		Mobile.showHeading();
		Iterator <Map.Entry<Long,Mobile>> iter = mobiles.entrySet().iterator();
		while(iter.hasNext()) {
