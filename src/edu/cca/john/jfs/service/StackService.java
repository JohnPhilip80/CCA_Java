...
import edu.cca.john.jfs.repositories.StackRepository;

public class StackService implements ServiceCRUD {

	private StackRepository repo;
	private Scanner scanner;
	
	public StackService() {
		repo= new StackRepository();
	...
	@Override
	public void readAll() {
		Stack<Mobile> mobiles = repo.readAll();
		Mobile.showHeading();
